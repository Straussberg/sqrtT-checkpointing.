...
> **"Adaptive Checkpointing with √T Latency Scaling for Distributed Simulations"**
...
```bash
.
├── paper.pdf             # Full article (LaTeX compiled)
├── README.md             # This file
...
└── LICENSE               # Open-source license (MIT/BSD recommended)
